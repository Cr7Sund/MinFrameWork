...
namespace Cr7Sund
{
    public static class Log
    {
        ...
        {
            string result = log.Format(LogLevel.Trace, LogChannel.Undefine, format, args);
        ...
        {
            string result = log.Format(LogLevel.Trace, LogChannel.Undefine, obj.ToString());
        ...
        {
            string result = log.Format(LogLevel.Trace, logChannel, format, args);
        ...
        {
            string result = log.Format(LogLevel.Debug, LogChannel.Undefine, format, args);
        ...
        {
            string result = log.Format(LogLevel.Debug, LogChannel.Undefine, obj.ToString());
        ...
        {
            string result = log.Format(LogLevel.Debug, logChannel, format, args);
        ...
        {
            string result = log.Format(LogLevel.Info, LogChannel.Undefine, format, args);
        ...
        {
            string result = log.Format(LogLevel.Info, LogChannel.Undefine, obj.ToString());
        ...
        {
            string result = log.Format(LogLevel.Warn, LogChannel.Undefine, format, args);
        ...
        {
            string result = log.Format(LogLevel.Warn, LogChannel.Undefine, obj.ToString());
        ...
        {
            string result = log.Format(LogLevel.Warn, logChannel, format, args);
        ...
        {
            string result = log.Format(LogLevel.Error, LogChannel.Undefine, format, args);
        ...
        {
            string result = log.Format(LogLevel.Error, LogChannel.Undefine, obj.ToString());
        ...
        private static void Error(string prefix, Exception exception)
        {
            if (null == exception)
            {
        ...
        {
            string result = log.Format(LogLevel.Error, logChannel, format, args);
        ...
        {
            string result = log.Format(LogLevel.Fatal, LogChannel.Undefine, format, args);
        ...
        {
            string result = log.Format(LogLevel.Fatal, LogChannel.Undefine, obj.ToString());
        ...
        {
            string result = log.Format(LogLevel.Fatal, logChannel, format, args);
