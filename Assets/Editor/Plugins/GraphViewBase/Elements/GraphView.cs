    ...
    public abstract class GraphView : VisualElement
    {
        ...
        private static StyleSheet DefaultStyle
        {
            get
            {
                ...
                {
                    s_DefaultStyle = AssetDatabase.LoadAssetAtPath<StyleSheet>(AssetDatabase.GUIDToAssetPath("77fe4517b4446384c9b89a214f2c016c"));
                }
        ...
        protected internal GraphElementContainer ContentContainer { get; private set; }
