...
namespace UnityEditor.GraphView
{
    public class Edge : BaseEdge
    {
        ...
        private Color m_selectColor = s_DefaultSelectedColor;
        private Color m_unselectedColor = s_DefaultColor;
        ...
        public virtual Color ColorSelected { get => m_selectColor; set => m_selectColor = value; }
        public virtual Color ColorUnselected { get => m_unselectedColor; set => m_unselectedColor = value; }
