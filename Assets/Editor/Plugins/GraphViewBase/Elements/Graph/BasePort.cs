...
namespace UnityEditor.GraphView
{
    public class BasePort : VisualElement, IPositionable
    {
        ...
        /// </summary>
        protected static VectorImage portCircleGraphics = null;
        protected static VectorImage PortCircleGraphics
        {
            get
            {
                if (portCircleGraphics == null)
                {
                    ...
                    RepaintCircleGraphics(portCircleGraphics, Color.white);
                }
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        protected static void RepaintCircleGraphics(VectorImage graphic, Color strokeColor)
        {
            using (var painter = new Painter2D())
            {
                ...
                painter.Stroke();
                painter.SaveToVectorImage(graphic);
                // painter.Clear();
            }
        }
