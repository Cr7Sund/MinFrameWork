...
namespace Cr7Sund.Editor
{
    public static class FieldDrawerFactory
    {
        ...
        static readonly MethodInfo createFieldMethod = typeof(FieldDrawerFactory).GetMethod("CreateFieldSpecific", BindingFlags.Static | BindingFlags.Public);

        static FieldDrawerFactory()
        {
