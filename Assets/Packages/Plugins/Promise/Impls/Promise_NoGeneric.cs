...
namespace Cr7Sund.Package.Impl
{
    public class Promise : IPromise, IPromiseTaskSource, IPoolNode<Promise>
    {
        ...
        /// </summary>
        public static readonly HashSet<IPromiseInfo> PendingPromises =
        ...
        public static ReusablePool<ListPoolNode<RejectHandler>> _rejectListPool;
        public static ReusablePool<ListPoolNode<ProgressHandler>> _progressListPool;
        ...
        protected PromiseTaskCompletionSourceCore _core;
        ...
        public PromiseTask Task
        {
            ...
            {
                ValidateToken();
                return new PromiseTask(this, _version);
            }
        }
        #endregion
