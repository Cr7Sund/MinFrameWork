namespace Cr7Sund.NodeTree.Api
{
    ...
    /// </summary>
    public interface IControllerModule : IUpdatable, ILateUpdate, IController, ILoadAsync<INode>, IInjectable
    {
        /// <summary>
        ...
        bool AddController<T>() where T : IController;
        ...
        bool RemoveController<T>() where T : IController;
